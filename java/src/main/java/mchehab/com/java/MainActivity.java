...
import mchehab.com.java.cluster.MarkerClusterItem;
import mchehab.com.java.cluster.MarkerClusterRenderer;
import mchehab.com.java.location.LocationHandler;
import mchehab.com.java.location.LocationResultListener;
import mchehab.com.java.placedetail.PlaceDetailsActivity;
...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback, LocationResultListener, PlaceSelectedListener {
    ...
    private void setClusterClickListener(){
        clusterManager.setOnClusterClickListener(cluster -> {
            ...
            new ListViewDialog(MainActivity.this, list, this).showDialog();
            return true;
        });
    }
